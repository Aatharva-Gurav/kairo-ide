    ...
    <div className="grid min-h-svh lg:grid-cols-2 bg-background text-foreground">
      ...
      <div className="relative hidden bg-muted/30 lg:flex items-center justify-center p-12 border-l border-border/60">
        <div className="flex flex-col items-center text-center max-w-sm">
          ...
          <h2 className="text-lg font-bold tracking-tight text-foreground">Modern Desktop Code Editor</h2>
          <p className="text-xs text-muted-foreground mt-2 leading-relaxed">
            Engineered for high performance with Monaco Editor, native desktop workspaces, and seamless cloud synchronization.
          </p>
        </div>
      </div>
    </div>
